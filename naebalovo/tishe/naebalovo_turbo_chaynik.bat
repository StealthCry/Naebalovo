...
set "TEMP_BAT=%TEMP%\chaynik_%RANDOM%.bat"
...
echo --filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="bin\tls_clienthello_4pda_to.bin" --new ^
...
echo --filter-tcp=80,443 --hostlist="..\files\sites.txt.gz" --ipset="..\files\ipv4.txt.gz" --ipset="..\files\ipv6.txt.gz" --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="bin\tls_clienthello_4pda_to.bin" --new ^
...
echo --filter-tcp=80,443 --ipset="..\files\ipv4.txt.gz" --ipset="..\files\ipv6.txt.gz" --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="bin\tls_clienthello_4pda_to.bin" --new ^
